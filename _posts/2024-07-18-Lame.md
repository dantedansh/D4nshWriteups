...
excerpt: En este post resolveremos la maquina Lame de la plataforma Hack The box, dónde veremos conceptos sobre servicios cómo el SMB y FTP.
date: "2024-07-18"
classes: wide
header:
  teaser: ({{ site.baseurl }}{{ site.baseurl }}/assets/images/Maquinas/Lame/lame.png)
...
![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/ports.png)
...
![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/nmap_scan.png)
...
![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/ftp.png)
...
![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/read_write.png)
...
![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/use.png)

Vemos su modo de uso.

Y lo vamos a ejecutar cómo nos indica, primero nos pondremos en escucha en un puerto:

![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/listener.png)
...
![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/exploit.png)

Y podemos ver que recibimos la conexión reversa donde pusimos el el puerto 4040 en escucha.

![image]({{ site.baseurl }}/assets/images/Maquinas/Lame/root.png)
